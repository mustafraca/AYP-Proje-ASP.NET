    ...
    public partial class MusteriG : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (reader.Read())
            {
                komut.Dispose();
                reader.Close();
                komut = new SqlCommand("UPDATE Musteri SET Musterino=@Musterino, Ad=@Ad, Soyad=@Soyad, Ctelefon=@Ctelefon, Eposta=@Eposta, Sehir=@Sehir WHERE Musterino='" + TextBox3.Text.ToString() + "'", baglanti);
